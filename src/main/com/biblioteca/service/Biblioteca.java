...
import main.com.biblioteca.dao.LivroDAO;

import main.com.biblioteca.dao.leitorDAO;
import main.com.biblioteca.model.Leitor;
...
public class Biblioteca {
   ...
   Leitor leitor;
    ...
    public void rodar() throws Throwable {
        ...
        while (true){
            ...
            System.out.println(
                    ...
                    "\n1 - Emprestar Livro" +
                    "\n2 - Adicionar Livro" +
                    "\n3 - Visualizar Livros Disponiveis" +
                    "\n4 - sair...");
    ...
    public void consultarMediaNota(){
        System.out.println(livroDAO.consultarMedia("obterMediaNotaLivros"));
    }
}
